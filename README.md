...
1. Подключите питание +24В к разъему X1
...
индекс пакета запроса 0x0020. В регистрах 0x20+ получим результат расшифровки ответа целевого прибора. 
...
- результат прочитайте в регистрах 0x20+, там будет файл запроса, причём первый байт будет содержать длину файла.

### В память прибора можно завести под тем же индексом 42 файла с инструкциями по обработке ответа, полученного от целевого прибора (файлы шаблонов ответа). 
...
4. Настройте Modbus-регистры для работы с целевыми приборами
